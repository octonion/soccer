...
drop table if exists mls._schedule_factors;

create table mls._schedule_factors (
	team_id			text,
        offensive               float,
        defensive		float,
        strength                float,
