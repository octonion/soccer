...
dbWriteTable(con,c("laliga","_parameter_levels"),parameter_levels,row.names=TRUE)
...
dbWriteTable(con,c("laliga","_basic_factors"),as.data.frame(combined),row.names=TRUE)
