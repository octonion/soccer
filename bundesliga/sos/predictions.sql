...
from bundesliga.games g
join bundesliga._schedule_factors sf1
  on (sf1.team_id)=(g.home_team)
join bundesliga._schedule_factors sf2
  on (sf2.team_id)=(g.away_team)

join bundesliga._factors o
  on (o.parameter,o.level)=('field','offense_home')
join bundesliga._factors d
  on (d.parameter,d.level)=('field','defense_home')

join bundesliga._basic_factors i
