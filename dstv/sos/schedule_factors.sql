...
drop table if exists dstv._schedule_factors;

create table dstv._schedule_factors (
	team_id			text,
        offensive               float,
        defensive		float,
        strength                float,
