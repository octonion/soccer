...
dbWriteTable(con,c("seriea","_parameter_levels"),parameter_levels,row.names=TRUE)
...
dbWriteTable(con,c("seriea","_basic_factors"),as.data.frame(combined),row.names=TRUE)
