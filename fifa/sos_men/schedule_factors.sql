...
drop table if exists fifa.men_schedule_factors;

create table fifa.men_schedule_factors (
	team_id			text,
        offensive               float,
        defensive		float,
        strength                float,
...
where r.year between 2008 and 2018
);
...
strength=o.strength
from fifa.men_schedule_factors o
...
from rs
where
  (men_schedule_factors.team_id)=(rs.team_id);
