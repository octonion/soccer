...
*
skellam(exp(bf.estimate)*h.offensive*v.defensive*o.exp_factor/3.0,
	exp(bf.estimate)*v.offensive*h.defensive*d.exp_factor/3.0,'win')
+
0.5*
skellam(exp(bf.estimate)*h.offensive*v.defensive*o.exp_factor,
	exp(bf.estimate)*v.offensive*h.defensive*d.exp_factor,'tie')
*
skellam(exp(bf.estimate)*h.offensive*v.defensive*o.exp_factor/3.0,
	exp(bf.estimate)*v.offensive*h.defensive*d.exp_factor/3.0,'tie')
as home_p,
...
*
skellam(exp(bf.estimate)*h.offensive*v.defensive*d.exp_factor/3.0,
	exp(bf.estimate)*v.offensive*h.defensive*o.exp_factor/3.0,'win')
+
0.5*
skellam(exp(bf.estimate)*h.offensive*v.defensive*d.exp_factor,
	exp(bf.estimate)*v.offensive*h.defensive*o.exp_factor,'tie')
*
skellam(exp(bf.estimate)*h.offensive*v.defensive*d.exp_factor/3.0,
	exp(bf.estimate)*v.offensive*h.defensive*o.exp_factor/3.0,'tie')
as home_p,
...
*
skellam(exp(bf.estimate)*h.offensive*v.defensive/3.0,
	exp(bf.estimate)*v.offensive*h.defensive/3.0,'win')
+
0.5*
skellam(exp(bf.estimate)*h.offensive*v.defensive,
	exp(bf.estimate)*v.offensive*h.defensive,'tie')
*
skellam(exp(bf.estimate)*h.offensive*v.defensive/3.0,
	exp(bf.estimate)*v.offensive*h.defensive/3.0,'tie')
as home_p,
