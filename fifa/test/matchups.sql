...
exp(bf.estimate)*h.offensive*v.defensive*(o.exp_factor*o.exp_factor),
exp(bf.estimate)*v.offensive*h.defensive*(d.exp_factor*d.exp_factor)
...
exp(bf.estimate)*h.offensive*v.defensive*(d.exp_factor*d.exp_factor),
exp(bf.estimate)*v.offensive*h.defensive*(o.exp_factor*o.exp_factor)
