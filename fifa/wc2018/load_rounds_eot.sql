...
+
skellam(exp(bf.estimate)*h.offensive*v.defensive*o.exp_factor,
	exp(bf.estimate)*v.offensive*h.defensive*d.exp_factor,'draw')
*
...
*
skellam(exp(bf.estimate)*h.offensive*v.defensive*o.exp_factor*(f.exp_factor-1),
	exp(bf.estimate)*v.offensive*h.defensive*d.exp_factor*(f.exp_factor-1),'draw')
as home_p,
...
+
skellam(exp(bf.estimate)*h.offensive*v.defensive*d.exp_factor,
	exp(bf.estimate)*v.offensive*h.defensive*o.exp_factor,'draw')
*
...
*
skellam(exp(bf.estimate)*h.offensive*v.defensive*d.exp_factor*(f.exp_factor-1),
	exp(bf.estimate)*v.offensive*h.defensive*o.exp_factor*(f.exp_factor-1),'draw')
as home_p,
...
set field='home'
where (year,team_id)=(2018,'rus');

update fifa.men_matrix_field
set field='away'
where (year,opponent_id)=(2018,'rus');
