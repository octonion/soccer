...
drop table if exists aleague._schedule_factors;

create table aleague._schedule_factors (
	team_id			text,
        offensive               float,
        defensive		float,
        strength                float,
...
strength=o.strength
from aleague._schedule_factors o
