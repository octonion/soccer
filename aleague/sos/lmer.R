...
dbWriteTable(con,c("aleague","_parameter_levels"),parameter_levels,row.names=TRUE)
...
dbWriteTable(con,c("aleague","_basic_factors"),as.data.frame(combined),row.names=TRUE)
