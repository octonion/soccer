...
drop table if exists epl._factors;

create table epl._factors (
       parameter		text,
       level			text,
       type			text,
       method			text,
...
from epl._parameter_levels npl
left outer join epl._basic_factors nbf
