...
drop table if exists epl._schedule_factors;

create table epl._schedule_factors (
	team_id			text,
        offensive               float,
        defensive		float,
        strength                float,
