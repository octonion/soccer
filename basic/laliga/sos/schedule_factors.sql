...
drop table if exists laliga._schedule_factors;

create table laliga._schedule_factors (
	team_id			text,
        offensive               float,
        defensive		float,
        strength                float,
...
strength=o.strength
from laliga._schedule_factors o
