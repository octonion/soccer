...
dbWriteTable(con,c("bundesliga","_parameter_levels"),parameter_levels,row.names=TRUE)
...
dbWriteTable(con,c("bundesliga","_basic_factors"),as.data.frame(combined),row.names=TRUE)
