...
drop table if exists bundesliga._schedule_factors;

create table bundesliga._schedule_factors (
	team_id			text,
        offensive               float,
        defensive		float,
        strength                float,
...
insert into bundesliga._schedule_factors
(team_id,offensive,defensive)
(
select o.level,o.exp_factor,d.exp_factor
from bundesliga._factors o
left outer join bundesliga._factors d
  on (d.level,d.parameter)=(o.level,'defense')
where o.parameter='offense'
);

update bundesliga._schedule_factors
...
strength=o.strength
from bundesliga._schedule_factors o
