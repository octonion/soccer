...
drop table if exists seriea._schedule_factors;

create table seriea._schedule_factors (
	team_id			text,
        offensive               float,
        defensive		float,
        strength                float,
...
strength=o.strength
from seriea._schedule_factors o
