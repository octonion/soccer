...
drop table if exists eflc._schedule_factors;

create table eflc._schedule_factors (
	team_id			text,
        offensive               float,
        defensive		float,
        strength                float,
