...
drop table if exists scottish._schedule_factors;

create table scottish._schedule_factors (
	team_id			text,
        offensive               float,
        defensive		float,
        strength                float,
...
insert into scottish._schedule_factors
(team_id,offensive,defensive)
(
select o.level,o.exp_factor,d.exp_factor
from scottish._factors o
left outer join scottish._factors d
  on (d.level,d.parameter)=(o.level,'defense')
where o.parameter='offense'
);

update scottish._schedule_factors
...
strength=o.strength
from scottish._schedule_factors o
