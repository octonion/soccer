...
drop table if exists uefa._schedule_factors;

create table uefa._schedule_factors (
	team_id			text,
	year			integer,
        offensive               float,
        defensive		float,
