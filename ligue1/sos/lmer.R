...
dbWriteTable(con,c("ligue1","_parameter_levels"),parameter_levels,row.names=TRUE)
...
dbWriteTable(con,c("ligue1","_basic_factors"),as.data.frame(combined),row.names=TRUE)
