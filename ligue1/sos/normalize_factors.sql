...
drop table if exists ligue1._factors;

create table ligue1._factors (
       parameter		text,
       level			text,
       type			text,
       method			text,
...
from ligue1._parameter_levels npl
left outer join ligue1._basic_factors nbf
