...
drop table if exists ligue1._schedule_factors;

create table ligue1._schedule_factors (
	team_id			text,
        offensive               float,
        defensive		float,
        strength                float,
...
strength=o.strength
from ligue1._schedule_factors o
